---
description: Phase 7 — build a feature test-first, task by task
argument-hint: <feature-name>
---

Build the feature: $ARGUMENTS. **Precondition:** its `tasks.md` exists (Phase 6). Read `workflow/lifecycle.md` (Phase 7), the feature's `lld.md` + `tasks.md`, the run's `conventions.md`, and the rigor profile.
